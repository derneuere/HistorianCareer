...
_FALLBACK_POOLS = {
    ...
    4:  ("objective_HC_RunTranscribeManuscript_x2", "objective_HC_RunZeitzeugen"),
    5:  ("objective_HC_RunTranscribeManuscript_x2", "objective_HC_RunZeitzeugen"),
    6:  ("objective_HC_RunAnalyzePrimarySource", "objective_HC_RunTranscribeManuscript_x2", "objective_HC_RunZeitzeugen"),
